"""
Main script for running PL-Rank experiments on Fat-Tree datacenter topology.

Usage:
    python main_fat_tree_pl_rank.py experiment.seed=0
"""
...
@hydra.main(version_base=None, config_path="settings", config_name="main_fat_tree_pl_rank")
def run(config: DictConfig):
    """Run VNE simulation with Fat-Tree topology."""
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running PL-Rank solver on Fat-Tree datacenter topology")
