"""
Modified main.py for running Simulated Annealing (SA) experiments on tree topology with clean switches.
...
Usage:
    python main_tree_sa.py p_net_setting=tree_p_net_setting \
...
def run(config: DictConfig):
    ...
    """
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running Simulated Annealing (SA) solver on tree topology with clean switches (routing-only)")
