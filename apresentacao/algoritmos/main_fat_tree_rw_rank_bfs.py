"""
Main script for running RW-Rank-BFS experiments on Fat-Tree datacenter topology.

Usage:
    python main_fat_tree_rw_rank_bfs.py experiment.seed=0
"""
...
@hydra.main(version_base=None, config_path="settings", config_name="main_fat_tree_rw_rank_bfs")
def run(config: DictConfig):
    """Run VNE simulation with Fat-Tree topology."""
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running RW-Rank-BFS solver on Fat-Tree datacenter topology")
