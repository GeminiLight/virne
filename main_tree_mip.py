"""
Modified main.py for running MIP experiments on tree topology with clean switches.
...
4. Run the MIP solver with the specified configuration

Usage:
    python main_tree_mip.py p_net_setting=tree_p_net_setting \
...
def run(config: DictConfig):
    ...
    """
    print(f"\n{'-' * 20}    Start     {'-' * 20}\n")
    print("Running MIP solver on tree topology with clean switches (routing-only)")
